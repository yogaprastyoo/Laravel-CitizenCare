            ...
            <form action="{{ route('officer.update', $officer->slug) }}" method="post">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="name" id="name" maxlength="60" value="{{ $officer->name }}"
                    ...
                    <div class="w-full">
                        ...
                        <input type="email" name="email" id="email" value="{{ $officer->email }}"
                    ...
                    <div>
                        ...
                        <select id="role" name="role"
                            ...
                            <option value="admin" @if ($officer->role == 'admin') selected @endif>Admin</option>
                            <option value="officer" @if ($officer->role == 'officer') selected @endif>Officer</option>
                        </select>
                        @error('role')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                                <span class="font-medium">Oh, snapp!</span> {{ $message }}
                    ...
                    <div class="w-full">
                        ...
                        <input type="password" name="password" id="password"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="DONT CHANGE IF NOT IMPORTANT!" autocomplete="off">
                        @error('password')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                                <span class="font-medium">Oh, snapp!</span> {{ $message }}
                            </p>
