<x-dashboard-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="mx-auto py-4 lg:py-8">
            {{-- Form Edit --}}
            <form action="{{ route('citizen.update', $citizen->national_id) }}" method="post">
                @csrf
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="name" id="name" maxlength="60" value="{{ $citizen->name }}"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="address" name="address"
                            ...
                            placeholder="Citizen Address">{{ $citizen->address }}</textarea>
                        @error('address')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">
                                <span class="font-medium">Oh, snapp!</span> {{ $message }}
                            </p>
