            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="{{ route('dashboard') }}" class="flex ms-2 md:me-24">
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">CitizenCare</span>
                    </a>
                </div>
                    ...
                    <div class="flex items-center ms-3">
                        <div>
                            <button type="button"
                                ...
                                data-dropdown-offset-distance="-25" data-dropdown-offset-skidding="150"
                        ...
                        <div id="userDropdown"
                            ...
                            <div class="px-4 py-3 text-sm text-gray-900 dark:text-white">
                                <div class="capitalize truncate">{{ Auth::user()->name }}</div>
